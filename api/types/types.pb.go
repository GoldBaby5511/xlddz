...
type PropItem struct {
	...
	PropId    PropType `protobuf:"varint,1,opt,name=prop_id,json=propId,proto3,enum=bs.types.PropType" json:"prop_id,omitempty"`
...
type BaseUserInfo struct {
	...
	NickName     string                `protobuf:"bytes,7,opt,name=nick_name,json=nickName,proto3" json:"nick_name,omitempty"`                                      //昵称
	UserType     BaseUserInfo_UserType `protobuf:"varint,8,opt,name=user_type,json=userType,proto3,enum=bs.types.BaseUserInfo_UserType" json:"user_type,omitempty"` //用户类别
	UserProps    []*PropItem           `protobuf:"bytes,9,rep,name=user_props,json=userProps,proto3" json:"user_props,omitempty"`                                   //用户道具
	MarketId     uint32                `protobuf:"varint,10,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`                                    //登录主渠道
	SiteId       uint32                `protobuf:"varint,11,opt,name=site_id,json=siteId,proto3" json:"site_id,omitempty"`                                          //登录子渠道
	RegMarketId  uint32                `protobuf:"varint,12,opt,name=reg_market_id,json=regMarketId,proto3" json:"reg_market_id,omitempty"`                         //注册主渠道
	RegSiteId    uint32                `protobuf:"varint,13,opt,name=reg_site_id,json=regSiteId,proto3" json:"reg_site_id,omitempty"`                               //注册子渠道
	RegisterData string                `protobuf:"bytes,14,opt,name=register_data,json=registerData,proto3" json:"register_data,omitempty"`                         //注册时间
	GateConnid   uint64                `protobuf:"varint,15,opt,name=gate_connid,json=gateConnid,proto3" json:"gate_connid,omitempty"`                              //关联的gate连接id
}
...
type UserRoomInfo struct {
	...
	BaseInfo  *BaseUserInfo `protobuf:"bytes,1,opt,name=base_info,json=baseInfo,proto3" json:"base_info,omitempty"`     //基础信息
	TableId   uint64        `protobuf:"varint,2,opt,name=table_id,json=tableId,proto3" json:"table_id,omitempty"`       //所有桌子
	SeatId    uint32        `protobuf:"varint,3,opt,name=seat_id,json=seatId,proto3" json:"seat_id,omitempty"`          //所在位置
	UserState uint32        `protobuf:"varint,4,opt,name=user_state,json=userState,proto3" json:"user_state,omitempty"` //用户状态
	LostCount uint32        `protobuf:"varint,5,opt,name=lost_count,json=lostCount,proto3" json:"lost_count,omitempty"` //玩家总输局
	DrawCount uint32        `protobuf:"varint,6,opt,name=draw_count,json=drawCount,proto3" json:"draw_count,omitempty"` //玩家总平局
	WinCount  uint32        `protobuf:"varint,7,opt,name=win_count,json=winCount,proto3" json:"win_count,omitempty"`    //玩家总胜局
}
...
var file_types_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf4, 0x02, 0x0a, 0x08, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x6e,
	...
	0x69, 0x74, 0x22, 0x38, 0x0a, 0x08, 0x52, 0x6f, 0x6f, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08,
	0x0a, 0x04, 0x4e, 0x6f, 0x6e, 0x65, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x47, 0x6f, 0x6c, 0x64,
	0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x10, 0x10, 0x12,
	0x0b, 0x0a, 0x07, 0x52, 0x65, 0x64, 0x50, 0x61, 0x63, 0x6b, 0x10, 0x20, 0x2a, 0x1f, 0x0a, 0x08,
	0x50, 0x72, 0x6f, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x6f, 0x6e, 0x65,
	0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x10, 0x01, 0x42, 0x08, 0x5a,

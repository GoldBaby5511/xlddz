...
type C_AddTimes struct {
	...
	BAddTimes uint32 `protobuf:"varint,1,opt,name=bAddTimes,proto3" json:"bAddTimes,omitempty"` // 是否加倍(0,不加倍;1,加倍)
}
...
func (x *C_AddTimes) GetBAddTimes() uint32 {
	if x != nil {
		return x.BAddTimes
	}
	return 0
...
var file_gameddz_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x07, 0x72, 0x6f, 0x62, 0x4c, 0x61, 0x6e, 0x64, 0x22, 0x2a, 0x0a, 0x0a, 0x43,
	0x5f, 0x41, 0x64, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x62, 0x41, 0x64,
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x62, 0x41,

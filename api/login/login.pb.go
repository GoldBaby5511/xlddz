...
const (
	CMDLogin_IDLoginReq  CMDLogin = 1 //登录请求
	CMDLogin_IDLoginRsp  CMDLogin = 2 //登录回复
	CMDLogin_IDLogoutReq CMDLogin = 3 //注销登录
	CMDLogin_IDLogoutRsp CMDLogin = 4 //注销登录
)
...
func (x *CMDLogin) UnmarshalJSON(b []byte) error {
...
var file_login_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x10, 0x01, 0x2a, 0x4c, 0x0a, 0x08, 0x43, 0x4d, 0x44, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x10, 0x04, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e,
}
...
var file_login_proto_goTypes = []interface{}{
	(CMDLogin)(0),               // 0: bs.login.CMDLogin
